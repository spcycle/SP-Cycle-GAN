...
##
        if mode == "CTtoMR":
            a_dir = r"C:\Users\Paolo\Documents\CT_MR_2D_Dataset_DA-master\CT_withGT"
            b_dir = r"C:\Users\Paolo\Documents\CT_MR_2D_Dataset_DA-master\MR_woGT_Comb"
        elif mode == "MRtoCT":
            a_dir = r"C:\Users\Paolo\Documents\CT_MR_2D_Dataset_DA-master\MR_withGT"
            b_dir = r"C:\Users\Paolo\Documents\CT_MR_2D_Dataset_DA-master\CT_woGT"
...
class SegGAN_MMWHS_Translate(Dataset):
    def __init__(self, a_dir = r"C:\Users\Paolo\Documents\CT_MR_2D_Dataset_DA-master\CT_withGT", b_dir=r"C:\Users\Paolo\Documents\CT_MR_2D_Dataset_DA-master\MR_withGT",
                 transform_image=None,transform_mask=None, crop_size = 192, mode='A2B', clahe = False):
        torch.manual_seed(42)
        self.transform_im = transforms.Compose(transform_image)
        self.transform_label = transforms.Compose(transform_mask)
        self.clahe = clahe
...
class SegGAN_MMWHS_CT_To_MR_UNet_Train(Dataset):
    def __init__(self, image_dir = None, transform_image=None,transform_mask=None, crop_size = 192, mode='MRtoCT', clahe = False):
        ...
        if mode == "MRtoCT":
            mask_dir = r"C:\Users\Paolo\Documents\CT_MR_2D_Dataset_DA-master\MR_withGT\Label"
        elif mode == "CTtoMR":
            mask_dir = r"C:\Users\Paolo\Documents\CT_MR_2D_Dataset_DA-master\CT_withGT\Label"
...
class SegGAN_MMWHS_Test_CT_or_MR(Dataset):
    def __init__(self, transform_image=None,transform_mask=None, crop_size = 192, mode='CT', clahe = False):

        if mode == "CT":
            image_dir = r"C:\Users\Paolo\Documents\CT_MR_2D_Dataset_DA-master\CT_withGT\Images"
            mask_dir = r"C:\Users\Paolo\Documents\CT_MR_2D_Dataset_DA-master\CT_withGT\Label"
            
        elif mode == "MR":
            image_dir = r"C:\Users\Paolo\Documents\CT_MR_2D_Dataset_DA-master\MR_withGT\Images"
            mask_dir = r"C:\Users\Paolo\Documents\CT_MR_2D_Dataset_DA-master\MR_withGT\Label"
