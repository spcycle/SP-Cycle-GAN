...
model_dir = r"D:\Saved_Models\MRtoCT_TrainedModels"
...
for model_folder in model_test_folders:
    ...
    if "MR_to_CT" in model_folder or "untranslated_mr" in model_folder:
        dataset = SegGAN_MMWHS_Test_CT_or_MR(transform_image = transforms_img, transform_mask = None, mode = "CT")
    if "CT_to_MR" in model_folder or "untranslated_ct" in model_folder:
        dataset = SegGAN_MMWHS_Test_CT_or_MR(transform_image = transforms_img, transform_mask = None, mode = "MR")
